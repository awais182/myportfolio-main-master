...
const CelestialsTravelsPage: React.FC = () => {
  const navigate = useNavigate();

  useEffect(() => {
    const elements = document.querySelectorAll('[data-celestial-animation]');
    elements.forEach((el, i) => {
      setTimeout(() => {
        el.classList.add('animate-celestial-in');
      }, i * 120);
    });
  }, []);
  ...
  return (
    <div className="bg-neutral-900 min-h-screen text-white">
      <style>{`
        ...
        .animate-celestial-in {
          animation: celestialIn 0.7s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
        [data-celestial-animation] {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-black text-white tracking-tighter leading-none mb-8">
              CELESTIALS <br/> <span className="text-purple-500">TRAVELS</span>
            </h1>
            <p className="text-xl text-neutral-300 font-medium leading-relaxed max-w-3xl mx-auto">
              Tourism mobile app for Pakistani northern areas featuring destination guides, booking system, local experiences, and cultural information for travelers.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-neutral-300 leading-relaxed mb-8">
              Created a comprehensive tourism mobile application that showcases the beauty and culture of Pakistani northern areas. The app serves as a complete travel companion with booking capabilities, local insights, and authentic experiences.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { metric: '25%', label: 'Tourism Bookings' },
              { metric: 'Won', label: 'Innovation Award' }
            ].map((outcome, index) => (
              <motion.div
                key={outcome.label}
...
export default CelestialsTravelsPage;