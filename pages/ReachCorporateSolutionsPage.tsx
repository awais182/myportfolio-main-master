...
const ReachCorporateSolutionsPage: React.FC = () => {
  const navigate = useNavigate();

  useEffect(() => {
    const elements = document.querySelectorAll('[data-reach-animation]');
    elements.forEach((el, i) => {
      setTimeout(() => {
        el.classList.add('animate-reach-in');
      }, i * 120);
    });
  }, []);
  ...
  return (
    <div className="bg-neutral-900 min-h-screen text-white">
      <style>{`
        ...
        .animate-reach-in {
          animation: reachIn 0.7s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
        [data-reach-animation] {
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              Corporate IT <br/>
              <span className="text-[#800000] italic">& SOLUTIONS</span>
            </motion.h1>
            ...
            >
              End-to-end corporate networking and communication solutions for Reach Corporate Solutions. Delivered comprehensive IT infrastructure including network setup, security implementation, and ongoing support services.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-32 pb-32">
        ...
        >
          ...
          <p className="text-lg text-neutral-300 leading-relaxed mb-8">
            Designed and implemented a complete corporate IT ecosystem for Reach Corporate Solutions, focusing on secure, scalable, and efficient communication infrastructure. The project covered network architecture, unified communications, cybersecurity, and managed services to support their corporate operations.
          </p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Efficiency Increase</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">100%</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Communication Upgrade</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">Advanced</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Security Posture</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">On Time</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">& Budget Delivery</div>
            </div>
          </div>
        </motion.section>
...
export default ReachCorporateSolutionsPage;