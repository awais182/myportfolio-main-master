...
const UKDevelopersNetworkPage: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#800000] italic">& DEPLOYMENT</span>
            </motion.h1>
            ...
            >
              Comprehensive network infrastructure deployment and management for UK-based development community. Enterprise-grade networking solutions with installation, configuration, and ongoing maintenance services.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-32 pb-32">
        ...
        >
          ...
          <p className="text-lg text-neutral-300 leading-relaxed mb-8">
            Led the complete network infrastructure overhaul for UK Developers Network, a community of over 500 developers. The project involved designing, installing, and managing a robust network ecosystem that supports high-availability development environments, secure remote access, and scalable cloud integrations.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-neutral-300">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#800000] mt-2 flex-shrink-0" />
                  Advanced security protocols including next-gen firewalls
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#800000] mt-2 flex-shrink-0" />
                  Cloud-native networking with hybrid infrastructure
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#800000] mt-2 flex-shrink-0" />
            ...
            <div>
              ...
              <ul className="space-y-3 text-neutral-300">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0" />
                  Implementing advanced security without impacting performance
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Network Uptime</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">40%</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Productivity Increase</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">0</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Security Breaches</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="text-3xl font-black text-[#800000] mb-2">300%</div>
              <div className="text-sm text-neutral-300 uppercase tracking-widest">Growth Capacity</div>
            </div>
          </div>
        </motion.section>
...
export default UKDevelopersNetworkPage;